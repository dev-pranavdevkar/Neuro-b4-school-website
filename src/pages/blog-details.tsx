...
//images
const test1 = '/images/testimonials/pic1.jpg';
const test2 = '/images/testimonials/pic2.jpg';
const test3 = '/images/testimonials/pic3.jpg';
									...
									<div className="comments-area" id="comments">
										...
										<div className="clearfix m-b20">
											...
											<div className="comment-respond" id="respond">
												<h4 className="comment-reply-title" id="reply-title">Leave a Reply <small> <Link style={{display:"none"}} href={"#"} id="cancel-comment-reply-link" rel="nofollow">Cancel reply</Link> </small> </h4>
