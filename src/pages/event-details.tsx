...
import { LightGallery } from './classes-details';
//images
const bnr1 = '/images/line2.png';
const large1 = '/images/blog/large/pic-large.jpg';
const recent2 = '/images/blog/recent-blog/pic2.jpg';
const recent3 = '/images/blog/recent-blog/pic3.jpg';
										...
										<div className="classes-details">
											<div className="class-info">
												<div className="dlab-post-title ">
													<h2 className="post-title m-t0"><Link href={"/event"}>Asertivelly recaptiualize best profesionally</Link></h2>
												</div>
												<div className="dlab-post-meta m-b20">
													<ul className="d-flex align-items-center">
														...
														<li className="post-author"><i className="la la-user"></i>By <Link href={"/event"}>demongo</Link> </li>
														<li className="post-comment"><i className="la la-comment"></i> <Link href={"/event"}>0 Comments</Link> </li>
													</ul>
												</div>
										...
										<div className="widget recent-posts-entry">
											...
											<div className="widget-post-bx">
												<div className="widget-post clearfix">
													...
													<div className="dlab-post-info">
														<div className="dlab-post-header">
															<h6 className="post-title"><Link href={"/event"}>Reasons Why You Cannot Learn Kids Education Well.</Link></h6>
														</div>
												...
												<div className="widget-post clearfix">
													...
													<div className="dlab-post-info">
														<div className="dlab-post-header">
															<h6 className="post-title"><Link href={"/event"}>Small But Important Things To Observe In Kids.</Link></h6>
														</div>
														<div className="dlab-post-meta">
															<ul>
																<li className="post-author">By Jone</li>
